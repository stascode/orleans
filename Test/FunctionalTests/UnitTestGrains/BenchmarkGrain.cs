...
{
    public class BenchmarkGrainState : GrainState
    {
        public string Name { get; set; }
        public IBenchmarkGrain Other { get; set; }

        public int DummyDelay { get; set; }
    }

    [Orleans.Providers.StorageProvider(ProviderName = "MemoryStore")]
    public class BenchmarkGrain : Grain<BenchmarkGrainState>, IBenchmarkGrain
    {
