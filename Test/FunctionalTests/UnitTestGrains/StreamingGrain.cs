...
namespace UnitTestGrains
{
    ...
    public class Streaming_ProducerGrain : Grain<Streaming_ProducerGrain_State>, IStreaming_ProducerGrain
    {
        ...
        {
            _logger = base.GetLogger("Test.Streaming_ProducerGrain " + base.RuntimeIdentity + "/" + base.IdentityString + "/" + base.Data.ActivationId);
        ...
        public virtual Task BecomeProducer(Guid streamId, string providerToUse, string streamNamespace)
        {
            ...
            producer.BecomeProducer(streamId, base.GetStreamProvider(providerToUse), streamNamespace);
    ...
    public class PersistentStreaming_ProducerGrain : Streaming_ProducerGrain, IStreaming_ProducerGrain
    {
        ...
        public override async Task OnActivateAsync()
        {
            ...
            _logger = base.GetLogger("Test.PersistentStreaming_ProducerGrain " + base.RuntimeIdentity + "/" + base.IdentityString + "/" + base.Data.ActivationId);
            _logger.Info("OnActivateAsync");
    ...
    public class Streaming_ConsumerGrain : Grain<Streaming_ConsumerGrain_State>, IStreaming_ConsumerGrain    
    {
        ...
        public override Task OnActivateAsync()
        {
            _logger = base.GetLogger("Test.Streaming_ConsumerGrain " + base.RuntimeIdentity + "/" + base.IdentityString + "/" + base.Data.ActivationId);
            _logger.Info("OnActivateAsync");    
        ...
        public async virtual Task BecomeConsumer(Guid streamId, string providerToUse, string streamNamespace)
        {
            ...
            await consumerObserver.BecomeConsumer(streamId, base.GetStreamProvider(providerToUse), streamNamespace);
    ...
    public class PersistentStreaming_ConsumerGrain : Streaming_ConsumerGrain, IPersistentStreaming_ConsumerGrain
    {
        ...
        {
            await base.OnActivateAsync();
            _logger = base.GetLogger("Test.PersistentStreaming_ConsumerGrain " + base.RuntimeIdentity + "/" + base.IdentityString + "/" + base.Data.ActivationId);
            _logger.Info("OnActivateAsync");
    ...
    public class Streaming_Reentrant_ProducerConsumerGrain : Streaming_ProducerConsumerGrain, IStreaming_Reentrant_ProducerConsumerGrain
    {
        ...
        public override async Task OnActivateAsync()
        {
            _logger = base.GetLogger("Test.Streaming_Reentrant_ProducerConsumerGrain " + base.RuntimeIdentity + "/" + base.IdentityString + "/" + base.Data.ActivationId);
            _logger.Info("OnActivateAsync");
            await base.OnActivateAsync();
        }
    ...
    public class Streaming_ProducerConsumerGrain : Grain, IStreaming_ProducerConsumerGrain
    {
        ...
        public override Task OnActivateAsync()
        {
            _logger = base.GetLogger("Test.Streaming_ProducerConsumerGrain " + base.RuntimeIdentity + "/" + base.IdentityString + "/" + base.Data.ActivationId);
            _logger.Info("OnActivateAsync");
            return TaskDone.Done;
        }
        public override Task OnDeactivateAsync()
        ...
        public Task BecomeProducer(Guid streamId, string providerToUse, string streamNamespace)
        {
            ...
            _producer.BecomeProducer(streamId, base.GetStreamProvider(providerToUse), streamNamespace);
            return TaskDone.Done;
        }
        ...
        public async Task BecomeConsumer(Guid streamId, string providerToUse, string streamNamespace)
        {
            ...
            await _consumer.BecomeConsumer(streamId, base.GetStreamProvider(providerToUse), streamNamespace);
        }
    ...
    public abstract class Streaming_ImplicitlySubscribedConsumerGrainBase : Grain
    {
        ...
        public override async Task OnActivateAsync()
        {
            _logger = base.GetLogger("Test.Streaming_ImplicitConsumerGrain1 " + base.RuntimeIdentity + "/" + base.IdentityString + "/" + base.Data.ActivationId);
        ...
        public async Task BecomeConsumer(Guid streamGuid, string providerToUse, string streamNamespace)
        {
            ...
            ConsumerObserver consumerObserver = ConsumerObserver.NewObserver(_logger);
            await consumerObserver.BecomeConsumer(streamGuid, base.GetStreamProvider(providerToUse), streamNamespace);
