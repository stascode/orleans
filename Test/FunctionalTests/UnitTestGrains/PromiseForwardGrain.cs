...
{
    public class SimpleGrainState : GrainState
    {
    ...
    public class PromiseForwardGrain : Grain<SimpleGrainState>, IPromiseForwardGrain
    {
        ...
        private ISimpleGrain GetSimpleGrain()
        {
            if( MySimpleGrain == null )
                MySimpleGrain = GrainFactory.GetGrain<ISimpleGrain>((new Random()).Next(), UnitTestGrainInterfacesConstants.SimpleGrainNamePrefix);
