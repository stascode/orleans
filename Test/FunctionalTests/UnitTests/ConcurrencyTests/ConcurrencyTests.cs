...
namespace UnitTests.ConcurrencyTests
{
    ...
    public class ConcurrencyTests : UnitTestBase
    {
        ...
        {
            IConcurrentGrain grain1 = GrainClient.GrainFactory.GetGrain<IConcurrentGrain>(GetRandomGrainId());
            IConcurrentReentrantGrain grain2 = GrainClient.GrainFactory.GetGrain<IConcurrentReentrantGrain>(GetRandomGrainId());
