...
namespace UnitTests.TimerTests
{
    ...
    public class TimerGrainReferenceProxy // : UnitTestGrains.ITimerGrain
    {
        ...
        public TimerGrainReferenceProxy(bool persist)
        {
            ...
            if (persistant)
            {
                persistantGrain = GrainClient.GrainFactory.GetGrain<ITimerPersistantGrain>(UnitTestBase.GetRandomGrainId());
            }
            else
            {
                grain = GrainClient.GrainFactory.GetGrain<ITimerGrain>(UnitTestBase.GetRandomGrainId());
            }
        }
