...
namespace UnitTests.General
{
    ...
    public class GrainReferenceCacheTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("GetGrain"), TestCategory("Cache")]
        ...
        {
            numGrainsCreated++;
            return TestConstants.GetSimpleGrain(GrainClient.GrainFactory);
        }
    }
}
