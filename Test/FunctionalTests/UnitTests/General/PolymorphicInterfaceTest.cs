...
namespace UnitTests.General
{
    ...
    public class PolymorphicInterfaceTest : UnitTestBase
    {
        ...
        {
            IA IARef = GrainClient.GrainFactory.GetGrain<IA>(GetRandomGrainId(), "UnitTestGrains.PolymorphicTestGrain");
        ...
        {
            IC ICRef = GrainClient.GrainFactory.GetGrain<IC>(GetRandomGrainId(), "UnitTestGrains.PolymorphicTestGrain");
            ...
            IF IFRef = GrainClient.GrainFactory.GetGrain<IF>(GetRandomGrainId(), "UnitTestGrains.PolymorphicTestGrain");
        ...
        public void Polymorphic_FactoryMethods()
        {
            ...
            IC ICRef = GrainClient.GrainFactory.GetGrain<IF>(GetRandomGrainId(), "UnitTestGrains.PolymorphicTestGrain"); // FRef factory method returns a polymorphic reference to ICRef
            Assert.AreEqual("B2", ICRef.B2Method().Result);

            IA IARef = GrainClient.GrainFactory.GetGrain<ID>(GetRandomGrainId(), "UnitTestGrains.PolymorphicTestGrain"); // DRef factory method returns a polymorphic reference to IARef
            Assert.AreEqual("A1", IARef.A1Method().Result);
        }
        ...
        {
            IServiceType serviceRef = GrainClient.GrainFactory.GetGrain<IServiceType>(GetRandomGrainId(), "UnitTestGrains.ServiceType");
        ...
        {
            IDerivedServiceType derivedRef = GrainClient.GrainFactory.GetGrain<IDerivedServiceType>(GetRandomGrainId(), "UnitTestGrains.DerivedServiceType");
