...
namespace UnitTests
{
    ...
    public class ProviderTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Providers")]
        ...
        // TODO: [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Providers")]
        [TestMethod, TestCategory("Failures"), TestCategory("Providers")]
        public void Providers_GenericExtensions()
        {
            IGenericExtensionTestGrain<string> grain = GrainClient.GrainFactory.GetGrain<IGenericExtensionTestGrain<string>>(2);
            IGenericTestExtension<string> extension = grain.AsReference<IGenericTestExtension<string>>();
