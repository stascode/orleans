...
namespace UnitTests
{
    ...
    public class ConfigTests
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("Logger")]
        public void ClientConfig_LogConsumers()
        {
            ...
            int expectedNumLogConsumers = 2; // 1 for .NET Trace and 1 for DummyLogConsumer; Log to Console and File are turned off
            
            var cfg = ClientConfiguration.LoadFromFile(filename);
            Assert.AreEqual(filename, cfg.SourceFile);

            TraceLogger.Initialize(cfg);
            Assert.AreEqual(expectedNumLogConsumers, TraceLogger.LogConsumers.Count, 
                "Number of log consumers: " + string.Join(",", TraceLogger.LogConsumers));
            Assert.AreEqual(typeof(LogWriterToTrace).FullName, TraceLogger.LogConsumers.First().GetType().FullName, "Log consumer type #1");
            Assert.AreEqual(typeof(DummyLogConsumer).FullName, TraceLogger.LogConsumers.Last().GetType().FullName, "Log consumer type #2");
        }
        ...
        public void ServerConfig_LogConsumers()
        {
            ...
            int expectedNumLogConsumers = 3; // 1 for .NET Trace; 1 for DummyLogConsumer; 1 for Console; Log to File is turned off
            ...
            Assert.AreEqual(expectedNumLogConsumers, TraceLogger.LogConsumers.Count, "Number of log consumers: " + string.Join(",", TraceLogger.LogConsumers));
            Assert.AreEqual("UnitTests.DummyLogConsumer", TraceLogger.LogConsumers.Last().GetType().FullName, "Log consumer type");
        }

        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("Limits")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("Azure")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("SqlServer")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("Providers")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("Gateway")]
        ...
        [TestMethod, TestCategory("Failures"), TestCategory("Config"), TestCategory("Azure")]
        public void ClientConfig_AzureInit_FromFile()
        {
            const string filename = "ClientConfig_AzureWebRole.xml";
        ...
        public void SiloConfig_Azure_Default()
        {
            ...
            string connectionString = TestConstants.DataConnectionString;
        ...
        //[TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("Azure")]
        //public void Config_Azure_RoleInstanceName()
        //{
        //    string roleInstanceName = "PartitionBenchmark.Simulator_IN_0";
        //    string deploymentId     = "656ef00d049542578484c975808027c1";

        //    var name = AzureConfigUtils.GetInstanceNameInternal(deploymentId, roleInstanceName);
        //    Console.WriteLine("GetInstanceName={0}", name);
        //    Assert.IsNotNull(name, "Instance name should not be Null");
        //    Assert.IsFalse(string.IsNullOrEmpty(name), "Instance name should not be Blank");
        //    Assert.AreEqual(roleInstanceName, name, "Instance name should be unchanged");
        //}
    ...
    {
        public void Log(Logger.Severity severity, TraceLogger.LoggerType loggerType, string caller, string message, IPEndPoint myIPEndPoint, Exception exception, int eventCode = 0)
        {
