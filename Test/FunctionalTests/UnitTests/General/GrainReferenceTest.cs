...
namespace UnitTests.General
{
    ...
    public class GrainReferenceTest : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("GrainReference")]
        public void GrainReferenceComparison_DifferentReference()
        {
            ISimpleGrain ref1 = TestConstants.GetSimpleGrain(GrainClient.GrainFactory);
            ISimpleGrain ref2 = TestConstants.GetSimpleGrain(GrainClient.GrainFactory);
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("AsynchronyPrimitives")]
        ...
        private static void TestGrainReferenceSerialization(int id, bool resolveBeforeSerialize, bool useJson)
        {
            ...
            var grain = TestConstants.GetSimpleGrain(GrainClient.GrainFactory);
        ...
        {
            GrainReference g1 = (GrainReference) GrainClient.GrainFactory.GetGrain<IMemoryStorageGrain>(0);
            GrainReference g2 = (GrainReference) GrainClient.GrainFactory.GetGrain<IMemoryStorageGrain>(0);
            Assert.AreEqual(g1, g2, "Should be equal GrainReference's");
            Assert.AreSame(g1, g2, "Should be same / intern'ed GrainReference object");
