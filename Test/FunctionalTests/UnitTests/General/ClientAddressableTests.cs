...
namespace UnitTests
{
    ...
    public class ClientAddressableTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("ClientAddressable"), TestCategory("Functional"), TestCategory("BVT")]
        ...
        public async Task ClientAddressableObjectsShouldReregisterBetweenSiloRestarts()
        {
            ...
            this.anchor = myOb;
            IClientAddressableTestClientObject myRef = await ((GrainFactory)GrainClient.GrainFactory).CreateObjectReference<IClientAddressableTestClientObject>(myOb);
            IClientAddressableTestGrain proxy = GrainClient.GrainFactory.GetGrain<IClientAddressableTestGrain>(GetRandomGrainId());
            await proxy.SetTarget(myRef);
            ...
            proxy = GrainClient.GrainFactory.GetGrain<IClientAddressableTestGrain>(GetRandomGrainId());
            await proxy.SetTarget(myRef);
