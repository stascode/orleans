...
namespace UnitTests.General
{
    ...
    public class EchoTaskGrainTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Echo")]
        ...
        [TestMethod, TestCategory("Failures"), TestCategory("Echo")]
        public async Task EchoTaskGrain_Blocking()
        {
            ...
            received = await g.CallMethodAV_Block(expectedEcho);
            Assert.AreEqual(expectedEcho, received, "CallMethodAV_Block");

            received = await g.CallMethodTask_Block(expectedEcho);
