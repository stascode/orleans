...
namespace UnitTests
{
    ...
    public class ErrorGrainTest : UnitTestBase
    {
        ...
        {
            IErrorGrain grain = GrainClient.GrainFactory.GetGrain<IErrorGrain>(GetRandomGrainId(), "UnitTestGrains.ErrorGrain");
        ...
        public void ArgumentTypes_ListOfGrainReferences()
        {
            ...
            IErrorGrain grain = GrainClient.GrainFactory.GetGrain<IErrorGrain>(GetRandomGrainId(), "UnitTestGrains.ErrorGrain");
            list.Add(GrainClient.GrainFactory.GetGrain<IErrorGrain>(GetRandomGrainId(), "UnitTestGrains.ErrorGrain"));
            list.Add(GrainClient.GrainFactory.GetGrain<IErrorGrain>(GetRandomGrainId(), "UnitTestGrains.ErrorGrain"));
