...
namespace UnitTests.General
{
    ...
    public class SelfManagedTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("ActivateDeactivate"), TestCategory("GetGrain")]
        public void SelfManaged_ActivateAndUpdate()
        {
            ISimpleSelfManagedGrain g1 = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>(1);
            ISimpleSelfManagedGrain g2 = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>(2);
            ...
            ISimpleSelfManagedGrain g1a = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>(1);
        ...
        public void SelfManaged_Guid_ActivateAndUpdate()
        {
            ...
            IGuidSimpleSelfManagedGrain g1 = GrainClient.GrainFactory.GetGrain<IGuidSimpleSelfManagedGrain>(guid1);
            IGuidSimpleSelfManagedGrain g2 = GrainClient.GrainFactory.GetGrain<IGuidSimpleSelfManagedGrain>(guid2);
            ...
            IGuidSimpleSelfManagedGrain g1a = GrainClient.GrainFactory.GetGrain<IGuidSimpleSelfManagedGrain>(guid1);
            Assert.AreEqual("one", g1a.GetLabel().Result);
        }

        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("ActivateDeactivate"), TestCategory("ErrorHandling"), TestCategory("GetGrain")]
        public void SelfManaged_Fail()
        {
            ...
            try
            {
                ...
                ISimpleSelfManagedGrain fail = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>(-2);
        ...
        public void SelfManaged_ULong_MaxValue()
        {
            ...
            ISimpleSelfManagedGrain g1 = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>(key1);
            ...
            ISimpleSelfManagedGrain g1a = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>((long)key1AsUlong);
        ...
        //[TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("General")]
        //public void SelfManaged_Observer()
        //{
        //    var simple = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>(3);
        ...
        {
            ISimpleSelfManagedGrain simple = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>(50);
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("ActivateDeactivate"), TestCategory("Reentrancy")]
        public void SelfManaged_Reentrant_RecoveryAfterExpiredMessage()
        {
            ...
            ISimpleSelfManagedGrain grain = GrainClient.GrainFactory.GetGrain<ISimpleSelfManagedGrain>(12);
            int num = 10;
