...
namespace UnitTests
{
    ...
    public class GrainReferenceCastTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Cast")]
        public void CastCheckReferenceNameForGrainClass()
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGrain));
        ...
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(IMultifacetTestGrain));
        ...
        // TODO: [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Cast")]
        [TestMethod, TestCategory("Cast")]
        public void CastExceptionContentsForCannotCast()
        {
            try
            {
                GrainReference grain = (GrainReference) GrainClient.GrainFactory.GetGrain<IGeneratorTestGrain>(GetRandomGrainId());
        ...
        {
            GrainReference grain = (GrainReference)TestConstants.GetSimpleGrain(GrainClient.GrainFactory);
        ...
        public void CastFailGrainRefSideCastFromPeer1()
        {
            ...
            try
            {
                IAddressable grain1 = GrainClient.GrainFactory.GetGrain<IGeneratorTestDerivedGrain1>(GetRandomGrainId());
                GrainReference cast = (GrainReference) grain1.AsReference<IGeneratorTestDerivedGrain2>();
            }
            catch (AggregateException ae)
            {
                throw ae.InnerException;
        ...
        public void CastFailGrainRefSideCastFromPeer2()
        {
            ...
            try
            {
                IAddressable grain2 = GrainClient.GrainFactory.GetGrain<IGeneratorTestDerivedGrain2>(GetRandomGrainId());
                GrainReference cast = (GrainReference)grain2.AsReference<IGeneratorTestDerivedGrain1>();
            }
            catch (AggregateException ae)
            {
                throw ae.InnerException;
        ...
        public void CastFailGrainRefDownCastFromParent()
        {
            ...
            try
            {
                GrainReference grain = (GrainReference) GrainClient.GrainFactory.GetGrain<IGeneratorTestDerivedGrain2>(GetRandomGrainId());
                GrainReference cast = (GrainReference) grain.AsReference<IGeneratorTestDerivedDerivedGrain>();
            }
            catch (AggregateException ae)
            {
                throw ae.InnerException;
        ...
        {
            IAddressable grain = TestConstants.GetSimpleGrain(GrainClient.GrainFactory);
            ISimpleGrain cast = grain.AsReference<ISimpleGrain>();
