...
namespace UnitTests.General
{
    ...
    public class RequestContextTests_Local
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("RequestContext")]
    ...
    internal class RequestContextGrainObserver : ISimpleGrainObserver
    {
        ...
        public RequestContextGrainObserver(Action<int, int, ResultHandle> action, ResultHandle result)
        {
            this.action = action;
            this.result = result;
        }
