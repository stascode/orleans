...
namespace UnitTests.StorageTests
{
    ...
    public class PersistenceGrainTests_Local : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Persistence")]
        ...
        public async Task Persistence_Grain_ReRead()
        {
            ...
            storageProvider.SetValue(grainType, (GrainReference) grain, "Field1", 42); // Update state data behind grain
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Persistence"), TestCategory("MemoryStore")]
        ...
        public async Task Persistence_Provider_Error_BeforeRead()
        {
            ...
            storageProvider.SetValue(grainType, (GrainReference) grain, "Field1", expectedVal); // Update state data behind grain
        ...
        public async Task Persistence_Provider_Error_AfterRead()
        {
            ...
            int newVal = 53;
            storageProvider.SetErrorInjection(ErrorInjectionPoint.None);
            storageProvider.SetValue(grainType, (GrainReference) grain, "Field1", newVal); // Update state data behind grain
        ...
        public async Task Persistence_Provider_Error_Stress_Read()
        {
            ...
            {
                int expectedVal = i;
                var grain = GrainClient.GrainFactory.GetGrain<IPersistenceProviderErrorGrain>(Guid.NewGuid());
                Guid guid = grain.GetPrimaryKey();
                string id = guid.ToString("N");
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Persistence"), TestCategory("Serialization")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Persistence"), TestCategory("Scheduler"), TestCategory("Reentrancy")]
        ...
        private void SetStoredValue(string providerName, string grainType, IGrain grain, string fieldName, int newValue)
        {
            ...
            foreach (var siloHandle in silos)
            {
                ...
                provider.SetValue(grainType, (GrainReference) grain, fieldName, newValue);
            }
        }
