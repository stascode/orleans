...
namespace UnitTests.StorageTests
{
    ...
    public class PersistenceProviderTests_Local
    {
        ...
        public void TestInitialize()
        {
            ...
            storageProviderManager = new StorageProviderManager(new GrainFactory());
            storageProviderManager.LoadEmptyStorageProviders(new ClientProviderRuntime(new GrainFactory())).WaitWithThrow(TestConstants.InitTimeout);
        ...
        public async Task PersistenceProvider_Azure_Read()
        {
            ...
            providerCfgProps.Add("DataConnectionString", TestConstants.DataConnectionString);
            var cfg = new ProviderConfiguration(providerCfgProps, null);
            await store.Init(testName, storageProviderManager, cfg);
