...
namespace UnitTests.StorageTests
{
    ...
    [TestClass]
    public class AzureTablePerfTests
    {
        ...
        public void AzureTablePerf_CheckOpRate_Insert()
        {
            AzureTablePerf_CheckOpRate(AzureTestOperationType.Insert);
        }

        [TestMethod, TestCategory("Azure"), TestCategory("Table"), TestCategory("Performance")]
        public void AzureTablePerf_CheckOpRate_Upsert()
        {
            AzureTablePerf_CheckOpRate(AzureTestOperationType.Upsert);
        }

        [TestMethod, TestCategory("Azure"), TestCategory("Table"), TestCategory("Performance")]
        public void AzureTablePerf_CheckOpRate_Read()
        {
            AzureTablePerf_CheckOpRate(AzureTestOperationType.Read);
        }

        private void AzureTablePerf_CheckOpRate(AzureTestOperationType opType)
        {
