...
namespace UnitTests.Stats
{
    ...
    public class StatsInitTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Client"), TestCategory("Stats")]
    ...
    public class SqlClientInitTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Client"), TestCategory("Stats"), TestCategory("SqlServer")]
