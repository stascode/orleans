...
namespace UnitTests.Streaming
{
    ...
    public class StreamProvidersTests_ProviderConfigNotLoaded : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Streaming"), TestCategory("Providers")]
        public void ProvidersTests_ConfigNotLoaded()
        {
            bool hasThrown = false;
            Guid streamId = Guid.NewGuid();
            // consumer joins first, producer later
            IStreaming_ConsumerGrain consumer = GrainClient.GrainFactory.GetGrain<IStreaming_ConsumerGrain>(Guid.NewGuid(), "UnitTestGrains.Streaming_ConsumerGrain");
            try
            {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("ServiceId"), TestCategory("Providers")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Config"), TestCategory("ServiceId")]
