...
namespace UnitTests.MessageCenterTests
{
    ...
    public class GatewaySelectionTest
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Functional"), TestCategory("Gateway"), TestCategory("SqlServer")]
        public async Task GatewaySelection_SqlServer()
        {
            string testName = TestContext.TestName;

            Console.WriteLine(TestConstants.DumpTestContext(TestContext));
            ...
            GlobalConfiguration cfg = new GlobalConfiguration
            {
                ...
                DataConnectionString = TestConstants.GetSqlConnectionString(TestContext)
            };
        ...
        {
            private readonly List<Uri> list;
