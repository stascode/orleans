...
namespace UnitTests
{
    ...
    public class GeneratorGrainTest : UnitTestBase
    {
        ...
        {
            IGeneratorTestGrain grain = GrainClient.GrainFactory.GetGrain<IGeneratorTestGrain>(GetRandomGrainId(), "GeneratorTestGrain.GeneratorTestGrain");
        ...
        {
            IGeneratorTestDerivedGrain2 grain = GrainClient.GrainFactory.GetGrain<IGeneratorTestDerivedGrain2>(GetRandomGrainId(), "GeneratorTestGrain.GeneratorTestDerivedGrain2");
