...
namespace UnitTests.CodeGeneration
{
    ...
    public class CodeGeneratorTests
    {
        ...
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGenericGrain1<>));
            Assert.AreEqual("ISimpleGenericGrain1<T>", si.TypeName, "TypeName [Client] = ISimpleGenericGrain1<T>");
        }
        ...
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGenericGrain1<>));
            Assert.AreEqual("ISimpleGenericGrain1<T>", si.Name);
        }
        ...
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGenericGrain1<>));
            Assert.AreEqual("SimpleGenericGrain1Factory<T>", si.FactoryClassName);
            Assert.AreEqual("SimpleGenericGrain1Factory", si.FactoryClassBaseName);
        }
        ...
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGenericGrain1<>));
            Assert.AreEqual("SimpleGenericGrain1Reference<T>", si.ReferenceClassName);
            Assert.AreEqual("SimpleGenericGrain1Reference", si.ReferenceClassBaseName);
        }
        ...
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGenericGrain1<>));
            Assert.AreEqual("SimpleGenericGrain1MethodInvoker<T>", si.InvokerClassName);
        ...
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGenericGrain1<>));
            Assert.AreEqual("ISimpleGenericGrain1<T>", si.InterfaceTypeName);
            Assert.AreEqual("ISimpleGenericGrain1`1", si.Type.Name);
        }
        ...
        public void ServiceInterface_Generic_RemoteInterfaceTypeName()
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGenericGrain1<>));
            Assert.AreEqual("ISimpleGenericGrain1<T>", si.InterfaceTypeName);
            //Assert.AreEqual("ISimpleGenericGrain1", interfaceData.RemoteInterfaceTypeBaseName);
        }
        ...
        {
            GrainInterfaceData si = new GrainInterfaceData(Language.CSharp, typeof(ISimpleGenericGrain1<>));
            Assert.AreEqual("SimpleGenericGrain1State<T>", si.StateClassName);
            Assert.AreEqual("SimpleGenericGrain1State", si.StateClassBaseName);
        }
